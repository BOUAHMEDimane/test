...
class SeriesController extends Controller
{
    ...
    {   
        ...
        $serie->date = date('Y-m-d H:i:s');
            ...
            return redirect()->route('series.create')
                ->with('success', 'serie crée avec succès.');
       
        //return back()->with("success", "Serie ajouter avec succé");
    ...
    public function update(Request $request, $id)
    {
        ...
        $serie->tags = request('tags');
        $serie->save();
        return redirect(route('series.edit'))->with('successMsg', 'Félicitation !! Votre serie a  été modifier avec succé');
